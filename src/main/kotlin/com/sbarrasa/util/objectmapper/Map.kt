...
inline fun <reified S : Any, reified T : Any> map(source: S, target: T, ignoreNulls: Boolean = true) {
...
inline fun <reified S : Any, reified T : Any> S.mapTo(target: T, ignoreNulls: Boolean = true): T {
   map(this, target, ignoreNulls)
   return target
}
